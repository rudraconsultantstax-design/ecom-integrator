...
const shopify = shopifyApp({
  ...
  // ecom-integrator is OPEN distribution (App Store-bound), unlike the OMS app's
  // Custom (SingleMerchant) distribution. Keep this on AppStore so the public
  // App Store install/OAuth flow is intact.
